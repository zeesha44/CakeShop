    ...
    <div class="container">
                    ...
                    <div class="row tm-header-inner">
                        ...
                        <nav class="col-md-6 col-12 tm-nav">
                            <ul class="tm-nav-ul">
                                ...
                                <li class="tm-nav-li"><a href="cart.php" class="tm-nav-link"><i
        ...
        <main>
            ...
            <div class="col-12 ">
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Pickup/Delivery Date</th>
                ...
                <a type="button" class="btn btn-primary btn-lg" href="customer_dashboard.php?">Back</a>
